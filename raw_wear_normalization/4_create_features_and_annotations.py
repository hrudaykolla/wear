...
min_max = True
mean_std = False
if min_max and not mean_std:
# change output folder
    raw_inertial_folder = './raw_all_min_max/inertial'
    inertial_folder = './data/wear/processed_raw_all_min_max/inertial_features/{}_frames_{}_stride'.format(frames, stride)
elif mean_std and not min_max:
    raw_inertial_folder = './raw_mean_std/inertial'
    inertial_folder = './data/wear/processed_raw_mean_std/inertial_features/{}_frames_{}_stride'.format(frames, stride)
